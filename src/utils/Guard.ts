...
export class Guard {
  ...
  /**
   * Check and returns succeeded: false when null or undefined
   * @example 
  ...
  /**
   * Check and returns succeeded: false when null or undefined in bulk
   * return succeeded: true when all args also returned succeeded
   * @example 
